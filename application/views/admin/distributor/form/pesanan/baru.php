    ...
    foreach ($data as $d1) { ?>
      <tr>
        ...
        <td>
          ...
          <a href="<?php echo base_url() ?>user/admin/distributor/proses_pesanan_distributor/<?php echo $d1['id_pesanan'] ?>" class="btn btn-info btn-xs" onclick="return confirm('Proses pesanan dari toko <?php echo  $d1['nama_toko'] ?> ')" >Proses Pesanan</a>
